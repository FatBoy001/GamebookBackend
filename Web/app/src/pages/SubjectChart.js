...
export const SubjectChart=(props)=>{
  ...
  useEffect(()=>{
    Axios.get(`https://${IpAddress}/get${props.chooseSubject}Games`).then((response)=>{
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: `${props.chooseClass} (${subjectTranslate(props.chooseSubject)})`,
        color:'#FFFFFF'
      },
    },
    scales: {
